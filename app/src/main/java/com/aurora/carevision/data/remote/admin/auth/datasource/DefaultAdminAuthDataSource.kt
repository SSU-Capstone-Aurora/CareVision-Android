...
class DefaultAdminAuthDataSource @Inject constructor(
    ...
    override suspend fun adminLogin(adminLoginRequest: AdminLoginRequest): BaseResponse<AdminLoginResponse> {
        return adminAuthService.adminLogin(adminLoginRequest)
    }
}
