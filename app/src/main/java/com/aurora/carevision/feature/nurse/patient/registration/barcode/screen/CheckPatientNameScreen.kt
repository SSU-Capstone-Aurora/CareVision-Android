...
fun CheckPatientNameRoute(
    ...
    CheckPatientNameScreen(
        ...
        navigateToCameraListInfo = navigateToCameraListInfo,
        patientName = state.patientName,
        patientNameValidation = state.patientNameValidation,
        enabledNextButton = state.enabledNextButton
    )
}
...
fun CheckPatientNameScreen(
    ...
    navigateToCameraListInfo: () -> Unit = {},
    patientName: String = "",
    patientNameValidation: Boolean = true,
    ...
    Column(
        ...
        Text(
            text = if(patientNameValidation) "${patientName} 환자가 맞나요?" else "해당하는 환자가 없습니다.",
